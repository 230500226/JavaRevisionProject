...
public class JavaStopWatch extends javax.swing.JFrame implements ActionListener {
    ...
    // This is the constructor for JavaStopWatch. It initializes the components of the frame.
    public JavaStopWatch() {
        initComponents();
...
private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaStopWatch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JavaStopWatch().setVisible(true);
            }
        });
    }
